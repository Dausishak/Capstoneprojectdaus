...
# Load your data and create the merged_df DataFrame

# Set up Seaborn style
sns.set(style="whitegrid")

# Streamlit - Sidebar for Dashboard Options
st.sidebar.title("Dashboard Options")

image = Image.open("D:/Profesional Certificate in Data Science UTM/Bismillah Capstone Project/UTMlogo.jpg")
...
# Streamlit - Raw Data Display
st.subheader('Raw Data')
selected_columns_raw = st.multiselect('Select Columns for Raw Data:', filtered_df.columns)
st.write(filtered_df[selected_columns_raw])
